...
// }
TEST(ControleurTest, VictoireDetecteeApresCoup)
{
    Plateau p;
    ...
    // Préparer une victoire rouge sur la ligne y=2 (petits)
    p.getCase(1,2)->setCercles(new Cercle(TailleCercle::petite, CouleurCercle::rouge), TailleCercle::petite);
    p.getCase(2,2)->setCercles(new Cercle(TailleCercle::petite, CouleurCercle::rouge), TailleCercle::petite);
    p.getCase(3,2)->setCercles(new Cercle(TailleCercle::petite, CouleurCercle::rouge), TailleCercle::petite);

    // Le contrôleur doit détecter la victoire
    bool victoire = p.victoire(CouleurCercle::rouge);

    EXPECT_TRUE(victoire);
}
